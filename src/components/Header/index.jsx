  ...
  return (
    <header className='header'>
      ...
      <div className='lang-cv-container'>
        {/* <Button href={`https://portfolio.luisefarfan.com/cv-${lang}.pdf`} text={cv} color="blue" className='w-fit mr-5' /> */}
        {/* TODO add again the CV based on the lang */}
        <Button href={`https://portfolio.luisefarfan.com/cv-en.pdf`} text={cv} color="blue" className='w-fit mr-5' />
        <LanguageSelector />
      </div>
